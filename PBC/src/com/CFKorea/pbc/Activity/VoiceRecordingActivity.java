...
public class VoiceRecordingActivity extends Activity implements View.OnClickListener, OnCompletionListener{
	...
	// 미리 상수 선언	
	  ...
	  public static final String COMPANY = "/CFKorea";
		...
		public static final String VOICE = "/PyungHwa/Voice";
		public static final String MY_STUDIO_VOICE = SDCARD + COMPANY + VOICE;
	  ...
	  public void onCreate(Bundle savedInstanceState)
	  {
	    ...
	    File file = new File(MY_STUDIO_VOICE);
	    file.mkdirs();
	    
	    // 미디어 레코더 저장할 파일 생성
	    
	    mFilePath = MY_STUDIO_VOICE;
