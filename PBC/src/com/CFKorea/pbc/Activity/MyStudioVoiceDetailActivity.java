...
public class MyStudioVoiceDetailActivity extends Activity implements OnClickListener,OnCompletionListener{
	int index;
	EditText title;
	EditText story;
	String indextitle;
	...
	public void onClick(View v) {
		...
		switch(v.getId())
	    {
	      ...
	      case R.id.submit:
	 	    ...
	 	    mCustomDialog = new CustomDialog(MyStudioVoiceDetailActivity.this,null,getResources().getText(R.string.send_message).toString(),leftClickListener,rightClickListener);
			mCustomDialog.show();
	 ...
	 private void mBtnStartPlayOnClick()
	  {
	    if (mPlayerState == PLAY_STOP)
	    {
	      ...
	      startPlay();
	      updateUI();
	      mBtnStartPlay.setImageResource(R.drawable.btn_pause);
	    }
	    else if (mPlayerState == PLAYING)
	    {
	      ...
	      pausePlay();
	      updateUI();
	      mBtnStartPlay.setImageResource(R.drawable.btn_play);
	    }
	  ...
	  public Handler handler = new Handler() {
		    ...
		    public void handleMessage(Message msg) {
		    	...
		    	finish();
		    		...
		    		Toast.makeText(getApplicationContext(), getResources().getText(R.string.Wifi_Error).toString(), Toast.LENGTH_SHORT).show();
		    	}
		    	//finish();
		    }
		};
	    ...
	    private View.OnClickListener leftClickListener = new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				MenuControll.sending(MyStudioVoiceDetailActivity.this);
