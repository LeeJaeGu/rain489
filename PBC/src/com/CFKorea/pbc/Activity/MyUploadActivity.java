	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    mWebView.setWebChromeClient(new WebChromeClient()
	    {
	         public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture) {
	               ...
	               i.setType("*/*");
	               MyUploadActivity.this.startActivityForResult(
	                       Intent.createChooser(i, "사진을 선택하세요"),
	                       FILECHOOSER_RESULTCODE);
	           }
	     });
	    Log.d(TAG,"mainloginid = " + MainActivity.mainloginid);
	    mWebView.loadUrl("http://115.68.182.113/Pyeonghwa/contents/contents_view.jsp?loginid="+MainActivity.mainloginid);
