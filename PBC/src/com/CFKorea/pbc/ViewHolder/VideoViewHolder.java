...
public class VideoViewHolder {
	...
	public VideoViewHolder(String id , String data, String display_Name, String size, String title, String duration, String date_added, String resolution , Bitmap thumnail){
		this.id = id;	
		this.data = data;	
